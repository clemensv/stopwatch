...
namespace StopwatchOverlay
{
    public partial class ControllerWindow : Window
    {
        ...
        protected override void OnSourceInitialized(EventArgs e)
        {
            ...
            RegisterHotKey(helper.Handle, HOTKEY_START_STOP, 0, VK_F9);
            RegisterHotKey(helper.Handle, HOTKEY_RESET, 0, VK_F10);
            RegisterHotKey(helper.Handle, HOTKEY_TOGGLE_OVERLAY, 0, VK_F11);
            RegisterHotKey(helper.Handle, HOTKEY_LAP, 0, VK_F12);
        }
        ...
        private void StartStopButton_Click(object sender, RoutedEventArgs e)
        {
            if (_isRunning)
            {
                ...
                _stopwatch.Stop();
                _isRunning = false;
                StartStopButton.Content = "▶ Start (F9)";
            ...
            else
            {
                ...
                _stopwatch.Start();
                _isRunning = true;
                StartStopButton.Content = "⏹ Stop (F9)";
        ...
        private void ToggleOverlayButton_Click(object sender, RoutedEventArgs e)
        {
            if (_overlayWindows.Count > 0)
            {
                ...
                ToggleOverlayButton.Content = "👁 Show (F11)";
            ...
            else
            {
                ...
                ToggleOverlayButton.Content = "🙈 Hide (F11)";
