...
The application also supports user-imported JPG, JPEG, PNG, and BMP backgrounds.
Those files stay in the user's local application-data folder and are never added
